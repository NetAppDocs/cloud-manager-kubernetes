...
NOTE: If no storage class is defined, the cluster will show there is an action required. Double-clicking the cluster on the Canvas will open the action page to add a storage class.
