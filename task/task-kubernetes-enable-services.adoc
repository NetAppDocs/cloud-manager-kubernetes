...
link:https://docs.netapp.com/us-en/cloud-manager-backup-restore/task-backup-kubernetes-to-s3.html[Go to the Cloud Backup docs to learn how to back up persistent volumes^].
