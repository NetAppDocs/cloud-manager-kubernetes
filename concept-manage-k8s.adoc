...
NOTE: Cloud Manager supports Astra Trident deployed using the Trident operator only. If you deployed Astra Trident using `tridentctl`, you cannot use Cloud Manager to manage your Kubernetes clusters. See the Astra Trident link:https://docs.netapp.com/us-en/trident/trident-get-started/kubernetes-deploy.html[Deployment overview^] for details.
