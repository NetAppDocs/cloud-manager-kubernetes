...
* https://docs.netapp.com/us-en/cloud-manager-connector/task-creating-connectors-azure.html[Create a Connector from Cloud Manager^] (recommended)
* https://docs.netapp.com/us-en/cloud-manager-connector/task-launching-azure-mktp.html[Create a Connector from the Azure Marketplace^]
* https://docs.netapp.com/us-en/cloud-manager-connector/task-installing-linux.html[Install the Connector on an existing Linux host^]
...
image:/media/diagram-kubernetes-azure.png[An architectural diagram of an AKS Kubernetes cluster and its connection to a Connecter and Cloud Volumes ONTAP in the same VPC.]
...
image:/media/diagram-kubernetes-azure-with-peering.png[An architectural diagram of an AKS Kubernetes cluster and its connection to a Connecter and Cloud Volumes ONTAP in a separate VPC.]
...
+
image:/media/screenshot-k8s-aks-obj-id.png[A screenshot of the system-assigned object ID window on the Azure management portal.]
