...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-creating-connectors-aws.html[Create a Connector from Cloud Manager^] (recommended)
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-launching-aws-mktp.html[Create a Connector from the AWS Marketplace^]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-installing-linux.html[Install the Connector on an existing Linux host in AWS^]
