...
* https://docs.netapp.com/us-en/cloud-manager-connector/task-creating-connectors-gcp.html[Create a Connector from Cloud Manager^] (recommended)
...
image:/media/diagram-kubernetes-google-cloud.png[An architectural diagram of an AKS Kubernetes cluster and its connection to a Connecter and Cloud Volumes ONTAP in the same VPC.]
...
+
image:/media/screenshot-gke-unique-id.png[A screenshot of the service account details in Cloud Console.]
