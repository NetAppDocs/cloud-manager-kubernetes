...
* https://docs.netapp.com/us-en/cloud-manager-sync/task-creating-connectors-aws.html[Create a Connector from Cloud Manager^] (recommended)
* https://docs.netapp.com/us-en/cloud-manager-sync/task-launching-aws-mktp.html[Create a Connector from the AWS Marketplace^]
* https://docs.netapp.com/us-en/cloud-manager-sync/task-installing-linux.html[Install the Connector on an existing Linux host in AWS^]
